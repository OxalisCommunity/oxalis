...
public class DocumentTypeIdentifierTest {
    ...
    public void testValueOf() throws Exception {
        ...
        DocumentTypeIdentifier documentTypeIdentifier = DocumentTypeIdentifier.valueOf(documentIdAsText);
    ...
    public void equals() {
        ...
        DocumentTypeIdentifier d1 = DocumentTypeIdentifier.valueOf(s);
        DocumentTypeIdentifier d2 = DocumentTypeIdentifier.valueOf(s);

        DocumentTypeIdentifier d3 = DocumentTypeIdentifier.valueOf(s2);
        assertEquals(d1,d2);
