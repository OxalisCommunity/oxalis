...
public interface MessageRepository {
     ...
     *
    public Long saveOutboundMessage(MessageMetaData messageMetaData, Document payloadDocument) throws PersistenceException;

    public Long saveInboundMessage(MessageMetaData messageMetaData, InputStream payload) throws PersistenceException;
     ...
     */
    void saveTransportReceipt(TransmissionEvidence transmissionEvidence, PeppolMessageMetaData peppolMessageMetaData) throws PersistenceException;
     ...
     * @param bytes
     */
    void saveNativeTransportReceipt(PeppolMessageMetaData peppolMessageMetaData, byte[] bytes) throws PersistenceException;
}
